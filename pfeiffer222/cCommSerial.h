...
//    bool open(QSerialPort& pSerialPort, QString portName, qint32 baudRate= QSerialPort::Baud9600);
    bool openDevice(quint16 PID= 29987, quint16 VID= 6790, qint32 baudRate= QSerialPort::Baud9600, qint32 delayMS=3000);
    QByteArray writeForBack(QByteArray& pWriteBuff, int lengthRead = 0);
