...
#include "../CoreToolkits/CoreToolkits.h"
...
namespace kome {
	...
	namespace plugin {
		...
		public:
			 ...
			 */
            static void onOpenSampleSet( kome::objects::SampleSet& sampleSet, kome::core::Progress* progress = nullptr );
			...
			/**
             * @fn static void detectSpecPeaks( kome::objects::DataSet& dataSet, kome::core::Progress* progress = nullptr )
			 * @brief spectrum peak detection
			 * @param[in] dataSet spectra to detect peaks
			 * @param[in] progress the object to show the progress
			 */
            static void detectSpecPeaks( kome::objects::DataSet& dataSet, kome::core::Progress* progress = nullptr );
			...
			/**
             * @fn static void detectChromPeaks( kome::objects::DataSet& dataSet, kome::core::Progress* progress = nullptr )
			 * @brief chromatogram peak detection
			 * @param[in] dataSet chromatograms to detect peaks
			 * @param[in] progress the object to show the progress
			 */
            static void detectChromPeaks( kome::objects::DataSet& dataSet, kome::core::Progress* progress = nullptr );
			...
			/**
             * @fn static void detect2DPeaks( kome::objects::DataGroupNode& group, kome::core::Progress* progress = nullptr )
			 * @brief detects 2D peaks
			 * @param[in] group the group to detect 2D peaks
			 * @param[in] progress the object to show the progress
			 */
            static void detect2DPeaks( kome::objects::DataGroupNode& group, kome::core::Progress* progress = nullptr );
