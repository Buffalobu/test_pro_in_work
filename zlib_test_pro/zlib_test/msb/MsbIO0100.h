/**
 * @file MsbIO0100.h
 * @brief interfaces of MsbIO100 class
 *
 * @author S.Tanaka
 * @date 2006.10.05
 * 
...
#ifndef __KOME_IO_MSB_IO_0100_H__
#define __KOME_IO_MSB_IO_0100_H__
...
namespace kome {
	namespace io {
		namespace msb {
			...
			/**
			 * @class MsbIO0100
			 * @brief msb format ver1.0 IO manager class
			 */
			class MsbIO0100 : public MsbManager {
			public:
				/**
				 * @fn MsbIO0100()
				 * @brief constructor
...
#endif	//  __KOME_IO_MSB_IO_0100_H__
