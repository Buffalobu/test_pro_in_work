	...
	namespace io {
		namespace msb {
			...
			protected:
                 ...
                 * @brief This method is called by SampleSet::openFile method. (override method)
				 * @param path file path
				 * @param progress
				 * @return If true, it succeeded to open the file
				 */
                virtual bool onOpenFile( const char* path, kome::core::Progress* progress = nullptr );
			...
			public:
                 ...
                 * @param treatment treatment object to be opened (If nullptr, opens all treatments.)
				 * @param progress
				 * @return If true, it succeeded to open the treatment.
				 */
                virtual bool onOpenSample( kome::objects::Sample* sample, kome::core::Progress* progress = nullptr);
                 ...
                 * @param treatment treatment object to be closed (If nullptr, closes all treatments.)
