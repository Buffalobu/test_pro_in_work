	...
	namespace core {
		...
		protected:
			 ...
			 * @return properties object specified section.
                       (If there isn't section specified name, this method returns nullptr.)
			 */
		...
		public:
             ...
             * @return section specified index (If the index is illegal, this method returns nullptr.)
			 */
			 ...
			 * @return parameter name specified section and index 
                       (If the section or the index is illegal, this method returns nullptr.)
			 */
		...
		public:
			...
			/**
             * @fn bool save( const char* path = nullptr )
			 * @brief save the ini file
             * @param[in] path ini file path. (If path is nullptr, it is saved to the same place as the loaded file.)
