/**
 * @file MsbIO0105.cpp
 * @brief implements of MsbIO0105 class
 *
 * @author S.Tanaka
 * @date 2007.03.29
 * 
...
// static members
MsbManager::DataValue MsbIO0105::m_fileHeader[] = {
	...
	DataValue( TYPE_USHORT, (unsigned short)5 ),				 //  3: Minor Version
...
MsbManager::DataValue MsbIO0105::m_dataHeader[] = {
...
MsbManager::DataValue MsbIO0105::m_groupInfo[] = {
...
MsbManager::DataValue MsbIO0105::m_spectrumInfo[] = {
...
MsbManager::DataValue MsbIO0105::m_partInfo[] = {
	...
	DataValue( TYPE_ULONGLONG, (unsigned long long)0 ),	   //  6: m/z Align
	DataValue( TYPE_ULONGLONG, (unsigned long long)0 )		//  7: Intensity Align
};

MsbManager::DataValue MsbIO0105::m_prop[] = {
	DataValue( TYPE_ULONG,  (unsigned int)0 ),	  //  0: Spectrum
...
// create string table
void MsbIO0105::createStringTable( char** stringTable ) {
	// get size
...
void MsbIO0105::getFileHeaderInfo( MsbSample& sample, char* stringTable ) {
	// add file info
...
// read spectrum group
void MsbIO0105::readDataGroupNodes(
...
void MsbIO0105::readDataGroupNodeProperties(
		std::map< unsigned int, kome::objects::DataGroupNode* >& groupMap,
		char* stringTable
) {
   // read header
...
// read spectrum part
void MsbIO0105::readSpectrumParts(
		std::map< unsigned int, MsbSpectrum* >& specMap
){
	// read header
	READ_FROM_FILE( m_dataHeader );
...
void MsbIO0105::readSpectrumProperties(
		std::map< unsigned int, MsbSpectrum* >& specMap,
		char* stringTable
...
void MsbIO0105::writeDataGroupNodes(
...
void MsbIO0105::writeDataGroupNodeProperties(
		std::vector< kome::objects::DataGroupNode* >& groups,
		std::map< kome::objects::DataGroupNode*, unsigned int >& groupMap
) {
	// get properties
...
// write spectrum data
void MsbIO0105::writeSpectrumData(
		unsigned int id,
...
void MsbIO0105::writeSpectrumParts( std::vector< SpectrumPartInfo >& parts ) {
...
void MsbIO0105::writeSpectrumProperties(
		kome::objects::DataSet& dataSet,
		std::map< kome::objects::Spectrum*, unsigned int >& spectrumMap
) {
	// get properties
...
void MsbIO0105::onReadSampleInfo( MsbSample& sample ) {
	// read file header
...
// open sample
void MsbIO0105::onReadMsb( MsbSample& sample ) {
	// create string table
	char* stringTable = NULL;
	createStringTable( &stringTable );
...
bool MsbIO0105::onWriteMsb(
	...
	// log
	LOG_INFO( FMT( "Writing MSB format sample. [ver 1.5]" ) );
