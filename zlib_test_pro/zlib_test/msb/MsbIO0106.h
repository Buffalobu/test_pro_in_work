/**
 * @file MsbIO0106.h
 * @brief interfaces of MsbIO0106 class
 *
 * @author S.Tanaka
 * @date 2007.07.19
 * 
...
#ifndef __KOME_IO_MSB_IO_0106_H__
#define __KOME_IO_MSB_IO_0106_H__
...
namespace kome {
	namespace io {
		namespace msb {
			...
			/**
			 * @class MsbIO0106
			 * @brief msb format ver1.6 IO manager class
			 */
			class MsbIO0106 : public MsbManager {
			public:
				/**
				 * @fn MsbIO0106()
				 * @brief constructor
...
#endif	//  __KOME_IO_MSB_IO_0106_H__
