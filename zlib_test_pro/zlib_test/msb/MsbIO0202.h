	...
	namespace io {
		namespace msb {
			...
			protected:
                ...
                /**
                 * @fn void writeSimplifyDataGroupNodes(unsigned int frameCnt )
                 ...
                 */
                void writeSimplifyDataGroupNodes(unsigned int frameCnt );
                ...
                /**
                 * @fn void writeSimplifyDataGroupNodeProperties( unsigned int frameCnt )
                 * @brief writes spectrum group properties
                 * @param groups spectrum group information array
                 * @param groupMap the map to store spctrum group ID
                 */
                void writeSimplifyDataGroupNodeProperties( unsigned int frameCnt );
                ...
                /**
                 * @fn void writeSimplifyDataGroupNodeUserProperties(unsigned int frameCnt )
                 * @brief writes spectrum group user properties
                 * @param groups spectrum group information array
                 * @param groupMap the map to store spctrum group ID
                 */
                void writeSimplifyDataGroupNodeUserProperties(unsigned int frameCnt );
