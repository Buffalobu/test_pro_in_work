/**
 * @file MsbIO0102.h
 * @brief interfaces of MsbIO0102 class
 *
 * @author S.Tanaka
 * @date 2006.10.16
 * 
...
#ifndef __KOME_IO_MSB_IO_0102_H__
#define __KOME_IO_MSB_IO_0102_H__
...
namespace kome {
	namespace io {
		namespace msb {
			...
			/**
			 * @class MsbIO0102
			 * @brief msb format ver1.2 IO manager class
			 */
			class MsbIO0102 : public MsbManager {
			public:
				/**
				 * @fn MsbIO0102()
				 * @brief constructor
...
#endif	//  __KOME_IO_MSB_IO_0102_H__
