...
namespace kome {
	namespace objects {
		...
		public:
             ...
             * @return sample object (If nullptr, the index is illegal.)
			 */
		...
		public:
			 ...
			 */
            bool openFile( const char* path, kome::core::Progress* progress = nullptr );
		...
		protected:
			 ...
			 * @return If true, it succeeded to open the file
			 */
            virtual bool onOpenFile( const char* path, kome::core::Progress* progress = nullptr ) = 0;
		...
		public:
             ...
             * @param[in,out] sample sample object to be opened (If nullptr, opens all samples.)
			 * @param[out] progress progress bar dialog
			 * @return If true, it succeeded to open the sample.
			 */
            virtual bool onOpenSample( Sample* sample, kome::core::Progress* progress = nullptr ) = 0;

			/**
			 * @fn virtual bool onCloseSample( Sample* sample ) = 0
			 * @brief This method is called by closeSample method. (abstract method)
             * @param[in,out] sample sample object to be closed (If nullptr, closes all samples.)
