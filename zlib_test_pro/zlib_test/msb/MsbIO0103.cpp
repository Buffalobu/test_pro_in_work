/**
 * @file MsbIO0103.cpp
 * @brief implements of MsbIO0103 class
 *
 * @author S.Tanaka
 * @date 2007.01.17
 * 
...
// static members
MsbManager::DataValue MsbIO0103::m_fileHeader[] = {
	...
	DataValue( TYPE_USHORT, (unsigned short)3 ),		//  3: Minor Version
...
MsbManager::DataValue MsbIO0103::m_dataHeader[] = {
...
MsbManager::DataValue MsbIO0103::m_groupInfo[] = {
...
MsbManager::DataValue MsbIO0103::m_spectrumInfo[] = {
...
MsbManager::DataValue MsbIO0103::m_partInfo[] = {
...
// create string table
void MsbIO0103::createStringTable( char** stringTable ) {
	// get size
...
void MsbIO0103::getFileHeaderInfo( MsbSample& sample, char* stringTable ) {
	// add file info
...
// read spectrum group
void MsbIO0103::readDataGroupNodes(
...
// read spectrum part
void MsbIO0103::readSpectrumParts(
		std::map< unsigned int, MsbSpectrum* >& specMap
){
	// read header
	READ_FROM_FILE( m_dataHeader );
...
void MsbIO0103::readSpectrumProperties(
		std::map< unsigned int, MsbSpectrum* >& specMap,
		char* stringTable
...
// read file property
void MsbIO0103::readFileProperties( MsbSample& sample, char* stringTable ) {
	// read header
	READ_FROM_FILE( m_dataHeader );
...
void MsbIO0103::writeDataGroupNodes(
...
// write spectrum data
void MsbIO0103::writeSpectrumData(
		unsigned int id,
...
void MsbIO0103::writeSpectrumParts( std::vector< SpectrumPartInfo >& parts ) {
...
void MsbIO0103::writeSpectrumProperties(
		kome::objects::DataSet& dataSet,
		std::map< kome::objects::Spectrum*, unsigned int >& spectrumMap
) {
	// get properties
	...
	for( unsigned int i = 0; i < properties.size(); i++ ) {
		...
		// set data
		m_specProp[ 0 ].val.ul = prop.id;			   // Spectrum ID
...
// write file property
void MsbIO0103::writeFileProperties( kome::objects::Sample& sample ) {
	// get properties
...
void MsbIO0103::onReadSampleInfo( MsbSample& sample ) {
	// read file header
...
// open sample
void MsbIO0103::onReadMsb( MsbSample& sample ) {
	// create string table
	char* stringTable = NULL;
	createStringTable( &stringTable );
...
bool MsbIO0103::onWriteMsb(
	...
	// log
	LOG_INFO( FMT( "Writing MSB format sample. [ver 1.3]" ) );
